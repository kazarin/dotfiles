...
run_once("urxvtd")
run_once("unclutter")
run_once("/home/zul/.config/awesome/lang.sh")
run_once("/home/zul/.config/awesome/disable_touchpad.sh")
-- }}}
...
-- {{{ Tags
tags = {
    names = { "www", "dev", "docs", "media", "etc", "msg" },
    layout = { layouts[5], layouts[1], layouts[3], layouts[4], layouts[5], layouts[5] }
}
...
awful.rules.rules = {
    ...
    { rule = { instance = "plugin-container" },
	  ...
	  { rule = { class = "Gimp" },
     	    properties = { tag = tags[1][4] },
            callbacl = awful.titlebar.add },
  { rule = { instance = "jetbrains-phpstorm" },
  properties = { floating = true },
  callback = function(c)
